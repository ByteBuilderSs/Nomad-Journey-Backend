...
from .views import RegisterView, LoginView,UserView,LogoutView,UserProfileList,UserProfileDetail,UserProfileEdit1,UserProfileEdit2,GetUsernameAndUserImageByUserId
