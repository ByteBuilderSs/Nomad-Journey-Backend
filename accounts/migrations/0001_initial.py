    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('langF', models.ManyToManyField(blank=True, default=None, null=True, related_name='langF', to='utils.language')),
                ('langL', models.ManyToManyField(blank=True, default=None, null=True, related_name='langL', to='utils.language')),
