    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('langF', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='langF', to='utils.language')),
                ('langL', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='langL', to='utils.language')),
